...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/9153e420426a8ae0e32ee.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n Bot Rental Prices\n⭔ 15k Per Group via E-Walet 1 Month\n⭔ 18k via pulsa 1 Month\n\n Premium Price Bot\n⭔ 8k per User 1 bulan\n\nPayment can be via Dana/Pulsa\n\nFor more details, you can chat with the owner\nhttps://wa.me/62895411954396 (Owner)\n\nDonate For Me : \n\n⭔ Pulsa/Dana: 089509952003\n⭔ QRIS : https://bit.ly/QRISPAY` }, { quoted: m })
            }
            break
            case 'sc': {
                m.reply('Script : https://github.com/DikaArdnt/Hisoka-Morou\n\n Dont Forget Give Star\n\nDonate : 089509952003 (Dana)\nQRIS : https://bit.ly/QRISPAY\n\n Dont Forget Donate')
            }
            break
            case 'chat': {
